...
cp $GITHUB_WORKSPACE/patches/Makefile.scons $GITHUB_WORKSPACE/x-wrt/package/devel/scons/Makefile
...
cp $GITHUB_WORKSPACE/patches/Makefile.ss $GITHUB_WORKSPACE/x-wrt/package/small/shadowsocks-libev/Makefile
